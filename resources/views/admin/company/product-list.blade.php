        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="text-center page-icon">
                    <div class="icon-wrapper"><img src="{{URL::to('/assets/images/icon-box-open.png')}}" width="28px" height="29px"></div>
                </div>
                <h1 class="page-header text-center">GESTIONS DES PRODUITS</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Importer une liste de produits </h5>
                ...
                <div class="modal-body">
                    <div class="">
                        <div class="">
                            <label class="btn btn-default btn-info btn-file">
                                Choisir un fichier <input type="file" name="bulk_upload" id="file-upload" style="display: none;">
                            </label>
