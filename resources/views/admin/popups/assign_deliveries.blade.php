                                    ...
                                    @if(!empty($deliveries))
                                        @foreach($deliveries as $delivery)
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{asset('assets/images')}}/{{$delivery['stores_id']}}/{{$delivery['delivery_pdf']}}" target="_blank" id="addPdfLink"><i class="fa fa-2x fa-file-pdf-o pdf-font"></i></a> {{$delivery['delivery_number']}}</td>
