...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="row">
            ...
            @endif
            <div class="col-lg-12">
                <a class="btn btn-success back-button" href="{{route('store.list', ['companyId' => $storee->company_id])}}"><i class="fa fa-arrow-circle-left"></i> Retour</a>
        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('store.list', ['companyId' => $storee->company_id])}}">{{$storee->company->company_name}}</a></li>
                    <li class="breadcrumb-item active">{{$storee->store_name}}</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <span class="companyName">{{$storee->store_name}}</span>
            </div>
        </div>
        <div class="clear20"></div>
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        @else
                            <tr>
                                <td colspan="4">Désolé, aucun employé n'a été trouvé.</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
