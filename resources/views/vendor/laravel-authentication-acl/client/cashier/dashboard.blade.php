                ...
                <tbody>
                    <tr>
                        ...
                        @foreach($deliveries as $key=>$delivery)
                            @if(!empty($delivery))
                                    <td @if($key==date('d-M-Y', strtotime($currentDate))) class="enabled-div" @endif>
                                    ...
                                    @if($dayDelivery['day_period']=='Matin')
                                        <table class="table table-striped table-bordered tbl-internal" >
                                            <tr>
                                                ...
                                                <td><input type="checkbox" name="delivery_id[]" value="{{$dayDelivery['id']}}" {{($dayDelivery['status']=='1')?'checked':''}} class="" @if($key!=date('d-M-Y', strtotime($currentDate))) disabled @endif> 
                                               </td>
                                                @endif
                                            </tr>
                            ...
                            @if(!empty($delivery))
                                    ...
                                    @if($dayDelivery['day_period']=='Apres - Midi')
                                        <table class="table table-striped table-bordered tbl-internal">
                                            <tr>
                                                <td>{{$dayDelivery['first_name']}}</td>
                                                <td><a href="#"><i class="fa fa-eye fa-fw"></i></a></td>
                                               <td><a href="{{URL::to('/delivery', ['id'=>$dayDelivery['id']])}}"><i class="fa fa-edit fa-fw"></i></a></td>
                                                <td><a href="#"><i class="fa fa-trash-o fa-fw"></i></a></td>
                                            </tr>
